...
class DataIngestion:
    ...
    def _load_env_variables(self):
        ...
        print('self.db_application_token',self.db_application_token)
        print('self.db_keyspace',self.db_keyspace)
    ...
    def run_pipeline(self):
        ...
        query="can you tell me the lowest budget iphone?"
